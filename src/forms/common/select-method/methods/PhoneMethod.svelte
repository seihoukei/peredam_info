...
<div class="spacy-below flex" transition:slide>
    ...
    {/if}
    <br>
    <MethodDetail name="Подсказка">Нажмите на ссылку в поле "Телефон" для набора номера или наберите его вручную. Если звонок не удался - выберите другой метод или попробуйте позже.</MethodDetail>
</div>
